...
namespace souffle {
using namespace ram;
class Sf_insert_print : public SouffleProgram {
private:
...
SouffleProgram *newInstance_insert_print(){return new Sf_insert_print;}
SymbolTable *getST_insert_print(SouffleProgram *p){return &reinterpret_cast<Sf_insert_print*>(p)->symTable;}
#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_insert_print: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_insert_print();
};
public:
factory_Sf_insert_print() : ProgramFactory("insert_print"){}
};
static factory_Sf_insert_print __factory_Sf_insert_print_instance;
}
#else
}
int main(int argc, char** argv)
{
souffle::CmdOptions opt(R"(insert_print.dl)",
R"(.)",
R"(.)",
false,
R"()",
