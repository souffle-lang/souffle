...
struct t_btree_3__0_2_1__100__101__111 {
using t_tuple = Tuple<RamDomain, 3>;
using t_comparator_0 = index_utils::comparator<0,2,1>;
using t_ind_0 = btree_set<t_tuple, t_comparator_0>;
t_ind_0 ind_0;
using iterator = t_ind_0::iterator;
struct context {
...
class Sf_default : public SouffleProgram {
private:
...
// -- Table: op_add
std::unique_ptr<t_btree_3__0_2_1__100__101__111> rel_23_op_add = std::make_unique<t_btree_3__0_2_1__100__101__111>();
souffle::RelationWrapper<4,t_btree_3__0_2_1__100__101__111,Tuple<RamDomain,3>,3,0> wrapper_rel_23_op_add;
// -- Table: op_div
...
for(const auto& env1 : range) {
Tuple<RamDomain,3> lower{{ramBitCast(env1[2]),0,0}};
Tuple<RamDomain,3> upper{{ramBitCast(env1[2]),0,0}};
lower[1] = MIN_RAM_SIGNED;
upper[1] = MAX_RAM_SIGNED;
lower[2] = MIN_RAM_SIGNED;
upper[2] = MAX_RAM_SIGNED;
auto range = rel_23_op_add->lowerUpperRange_100(lower, upper,READ_OP_CONTEXT(rel_23_op_add_op_ctxt));
for(const auto& env2 : range) {
if( (ramBitCast<RamSigned>(env2[1]) <= ramBitCast<RamSigned>(env1[0])) && (ramBitCast<RamSigned>(env2[1]) >= ramBitCast<RamSigned>(env1[0])) && !(rel_27_op_mul->contains(Tuple<RamDomain,3>{{ramBitCast(env1[0]),ramBitCast(env0[1]),ramBitCast(env2[2])}},READ_OP_CONTEXT(rel_27_op_mul_op_ctxt)))) {
...
Tuple<RamDomain,3> lower{{ramBitCast(env2[1]),0,0}};
Tuple<RamDomain,3> upper{{ramBitCast(env2[1]),0,0}};
lower[1] = MIN_RAM_SIGNED;
upper[1] = MAX_RAM_SIGNED;
lower[2] = MIN_RAM_SIGNED;
upper[2] = MAX_RAM_SIGNED;
...
if( (ramBitCast<RamSigned>(env4[1]) <= ramBitCast<RamSigned>(env3[2])) && (ramBitCast<RamSigned>(env4[1]) >= ramBitCast<RamSigned>(env3[2])) && !(rel_37_trie_level_end->contains(Tuple<RamDomain,2>{{ramBitCast(env1[1]),ramBitCast(env4[2])}},READ_OP_CONTEXT(rel_37_trie_level_end_op_ctxt)))) {
...
for(const auto& env1 : range) {
Tuple<RamDomain,3> lower{{ramBitCast(env1[1]),0,0}};
Tuple<RamDomain,3> upper{{ramBitCast(env1[1]),0,0}};
lower[1] = MIN_RAM_SIGNED;
upper[1] = MAX_RAM_SIGNED;
lower[2] = MIN_RAM_SIGNED;
upper[2] = MAX_RAM_SIGNED;
auto range = rel_23_op_add->lowerUpperRange_100(lower, upper,READ_OP_CONTEXT(rel_23_op_add_op_ctxt));
for(const auto& env2 : range) {
if( (ramBitCast<RamSigned>(env2[1]) <= ramBitCast<RamSigned>(RamSigned(1))) && (ramBitCast<RamSigned>(env2[1]) >= ramBitCast<RamSigned>(RamSigned(1)))) {
...
CREATE_OP_CONTEXT(rel_23_op_add_op_ctxt,rel_23_op_add->createContext());
for(const auto& env0 : *rel_27_op_mul) {
Tuple<RamDomain,3> lower{{ramBitCast(env0[2]),0,0}};
Tuple<RamDomain,3> upper{{ramBitCast(env0[2]),0,0}};
lower[1] = MIN_RAM_SIGNED;
upper[1] = MAX_RAM_SIGNED;
lower[2] = MIN_RAM_SIGNED;
upper[2] = MAX_RAM_SIGNED;
auto range = rel_23_op_add->lowerUpperRange_100(lower, upper,READ_OP_CONTEXT(rel_23_op_add_op_ctxt));
for(const auto& env1 : range) {
if( (ramBitCast<RamSigned>(env1[1]) <= ramBitCast<RamSigned>((ramBitCast<RamSigned>(env0[1]) - ramBitCast<RamSigned>(RamSigned(1))))) && (ramBitCast<RamSigned>(env1[1]) >= ramBitCast<RamSigned>(RamSigned(0)))) {
...
Tuple<RamDomain,3> lower{{ramBitCast(env6[1]),0,0}};
Tuple<RamDomain,3> upper{{ramBitCast(env6[1]),0,0}};
lower[1] = MIN_RAM_SIGNED;
upper[1] = MAX_RAM_SIGNED;
lower[2] = MIN_RAM_SIGNED;
upper[2] = MAX_RAM_SIGNED;
...
if( (ramBitCast<RamSigned>(env7[1]) <= ramBitCast<RamSigned>(env5[2])) && (ramBitCast<RamSigned>(env7[1]) >= ramBitCast<RamSigned>(env5[2]))) {
...
auto range = rel_23_op_add->lowerUpperRange_100(lower, upper,READ_OP_CONTEXT(rel_23_op_add_op_ctxt));
for(const auto& env1 : range) {
if( (ramBitCast<RamSigned>(env1[1]) <= ramBitCast<RamSigned>((ramBitCast<RamSigned>(env0[0]) - ramBitCast<RamSigned>(RamSigned(1))))) && (ramBitCast<RamSigned>(env1[1]) >= ramBitCast<RamSigned>(RamSigned(0)))) {
...
SouffleProgram *newInstance_default(){return new Sf_default;}
SymbolTable *getST_default(SouffleProgram *p){return &reinterpret_cast<Sf_default*>(p)->symTable;}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_default: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_default();
};
public:
factory_Sf_default() : ProgramFactory("default"){}
};
static factory_Sf_default __factory_Sf_default_instance;
}
#else
}
