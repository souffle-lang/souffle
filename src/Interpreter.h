...
protected:
    ...
    /** Create relation */
    void createRelation(const RamRelationRef& id) {
    ...
    /** Get relation */
    inline InterpreterRelation& getRelation(const RamRelationRef& id) {
    ...
    /** Drop relation */
    void dropRelation(const RamRelationRef& id) {
    ...
    /** Swap relation */
    void swapRelation(const RamRelationRef& ramRel1, const RamRelationRef& ramRel2) {
